using ChartConvertor.Activation;
...
using ChartConvertor.Views;

using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.UI.Xaml;

namespace ChartConvertor;

// To learn more about WinUI 3, see https://docs.microsoft.com/windows/apps/winui/winui3/.
public partial class App : Application
{
    // The .NET Generic Host provides dependency injection, configuration, logging, and other
    // services. https://docs.microsoft.com/dotnet/core/extensions/generic-host
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<SaveFileViewViewModel>();
            services.AddTransient<SaveFileViewPage>();
